...
const CATEGORY_LABELS: Record<string, string> = {
  agent: "Agent",
  knowledge_base: t("gene.text1"),
  workflow: t("gene.text2"),
  skill: t("gene.text3"),
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            >
              ...
              {createLoading ? t("gene.text25") : t("gene.text5")}
            </button>
          </div>
            ...
            <div className="min-h-[300px] bg-card border border-border rounded-xl p-4">
              {createResult ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-muted-foreground/50">
                  ...
                  <p className="text-smt("gene.text28"){t("gene.text5")}"</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="min-h-[300px] bg-card border border-border rounded-xl p-4">
              {instResult ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-muted-foreground/50">
                  ...
                  <p className="text-smt("gene.text36"){t("gene.start")}"</p>
                </div>
              )}
            </div>
          </div>
