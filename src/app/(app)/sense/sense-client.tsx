...
export function SenseClient() {
  ...
  const handleVideoAnalyze = useCallback(async () => {
    ...
    try {
      ...
      setVideoResult(null)
      alert(`{t("sense.failed")}: ${e.message}`)
    } finally {
  ...
  const tabs: Array<{ key: ActiveTab; label: string; icon: typeof Eye; available: boolean }> = [
    { key: "ocr", label: t("sense.text2"), icon: FileImage, available: ocrAvailable },
    { key: "asr", label: t("sense.text3"), icon: Volume2, available: asrAvailable },
    { key: "analyze", label: t("sense.text4"), icon: ImageIcon, available: multimodalAvailable },
    { key: "video", label: t("sense.text5"), icon: Video, available: true },
  ]
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">{t("sense.text7")}</p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              >
                {ocrPreview ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">{t("sense.text10")}</p>
                    <p className="text-xs text-muted-foreground/60">{t("sense.text11")}, PNG, BMP, TIFF, WebP</p>
                  </div>
                )}
              </div>
              <input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    <option value="chi_sim+eng">{t("sense.text13")}</option>
                    <option value="eng">English</option>
                    <option value="chi_sim">{t("sense.text14")}</option>
                    <option value="chi_tra">{t("sense.text15")}</option>
                    <option value="jpn">{t("sense.text16")}</option>
              ...
              >
                ...
                {ocrLoading ? t("sense.text17") : t("sense.start")}
              </button>
            </div>
                ...
                {ocrResult ? (
                  <div className="space-y-4">
                    ...
                    <div className="whitespace-pre-wrap text-sm leading-relaxed">
                      {ocrResult.text || t("sense.text21")}
                    </div>
                    {ocrResult.pages.length > 1 && (
                      <div className="space-y-3 pt-4 border-t border-border">
                        <h4 className="text-xs font-medium text-muted-foreground">{t("sense.text22")}</h4>
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-muted-foreground/50">
                    ...
                    <p className="text-smt("sense.text25")开始识别"</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">{t("sense.text28")}</p>
                  <p className="text-xs text-muted-foreground/60">{t("sense.text29")}, MP3, OGG, FLAC, WebM, M4A</p>
                </div>
              </div>
              <input
                ref={asrInputRef}
              ...
              <div>
                ...
                >
                  ...
                  <option value="ja">{t("sense.text16")}</option>
                ...
                {asrResult ? (
                  <div className="space-y-4">
                    <div className="flex gap-4 text-xs text-muted-foreground">
                      ...
                      <span>{t("sense.text12")}: <b className="text-foreground">{asrResult.language || t("sense.unknown")}</b></span>
                      <span>{t("sense.text20")}: <b className="text-foreground">{asrResult.engine}</b></span>
                    </div>
                    <div className="whitespace-pre-wrap text-sm leading-relaxed">
                      {asrResult.text || t("sense.text36")}
                    </div>
                    {asrResult.segments.length > 0 && (
                      <div className="space-y-2 pt-4 border-t border-border">
                        <h4 className="text-xs font-medium text-muted-foreground">{t("sense.time")}</h4>
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-muted-foreground/50">
                    ...
                    <p className="text-smt("sense.text37")开始转写"</p>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="min-h-[300px] bg-card border border-border rounded-xl p-4">
                {analyzeResult ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-muted-foreground/50">
                    ...
                    <p className="text-smt("sense.text25")开始分析"</p>
                  </div>
                )}
              </div>
            </div>
              ...
              >
                {videoFile ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">{t("sense.text48")}</p>
                    <p className="text-xs text-muted-foreground/60">{t("sense.text49")}, WebM, AVI, MOV, MKV</p>
                  </div>
                )}
              </div>
              <input
              ...
              <div className="min-h-[300px] bg-card border border-border rounded-xl p-4">
                {videoResult ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-muted-foreground/50">
                    ...
                    <p className="text-smt("sense.text59"){t("sense.text50")}"</p>
                  </div>
                )}
