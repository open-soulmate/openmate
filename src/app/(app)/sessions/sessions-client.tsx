...
import {
  History, Loader2, Search, RefreshCw, Trash2, Eye, MessageSquare,
  Clock, ChevronDown, ChevronRight, XCircle, Filter,
} from "lucide-react"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-xs text-zinc-500">
                          {session.source && <span className="px-1.5 py-0.5 bg-zinc-800 rounded">{session.source}</span>}
